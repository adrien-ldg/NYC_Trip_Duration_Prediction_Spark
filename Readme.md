...
Les principales pistes d’amélioration incluent l’enrichissement des features géographiques (clustering des zones de pickup et dropoff, intégration de distances routières), l’optimisation systématique des hyperparamètres et l’alignement encore plus direct de l’apprentissage sur la métrique RMSLE. Ce projet constitue une base solide démontrant la maîtrise de PySpark, de Spark SQL, Spark MLlib et des problématiques de machine learning à grande échelle.
